...
print("*******************************************************")
print("What r d most popular 3 articles of all time?")

query_for_first_3_records = "SELECT title, count(title) \
    AS views FROM articles, log \
    WHERE log.path LIKE concat('%',articles.slug) \
    GROUP BY articles.title, articles.author ORDER BY views DESC  limit 3"
...
print("What are the most popular authors?")
...
print("Dates which r more than 1% lead to errors?")
